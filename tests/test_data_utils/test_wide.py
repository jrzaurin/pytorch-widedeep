...
from pytorch_widedeep.utils.wide_utils import PrepareWide
...
preprocessor1 = PrepareWide(wide_cols, cross_cols)
...
def test_preprocessor1(input_df, expected_shape):
	wide_mtx = preprocessor1.fit(input_df)
...
preprocessor2 = PrepareWide(wide_cols)
...
def test_prepare_wide_wo_crossed(input_df, expected_shape):
	wide_mtx  = preprocessor2.fit(input_df)
	assert wide_mtx.shape[1] == expected_shape
