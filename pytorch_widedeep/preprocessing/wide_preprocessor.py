...
#         "native_country",
#     ]
#     crossed_cols = [("marital_status", "occupation")]
...
#     chunksize = 1000
#     wp_chunk = ChunkWidePreprocessor(
#         wide_cols=wide_cols,
#         crossed_cols=crossed_cols,
...
#         print(f"Chunk {i+1}")
#         wp_chunk.partial_fit(chunk)

#     encoded = wp_chunk.transform(df)
#     org = wp.inverse_transform(encoded)

#     encoded2 = wp_chunk.transform(df)
#     org2 = wp.inverse_transform(encoded2)

#     assert org.equals(org2)
