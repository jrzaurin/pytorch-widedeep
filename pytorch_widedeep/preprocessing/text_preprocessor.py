...
class TextPreprocessor(BasePreprocessor):
    ...
    Args:
        text_col (str): column in the input dataframe containing the texts
        max_vocab (int, default=30000): Maximum number of tokens in the vocabulary
        min_freq (int, default=5): Minimum frequency for a token to be part of the vocabulary
        maxlen (int, default=80): Maximum length of the tokenized sequences
        ...
        word_vectors_path (str, Optional): Path to the pretrained word vectors
        verbose (int, default=1): Enable verbose output.

    Attributes:
        vocab (Vocab): an instance of :class:`pytorch_widedeep.utils.fastai_transforms.Vocab`
        embedding_matrix (np.ndarray): Array with the pretrained embeddings
        tokens (List): List with Lists of str containing the tokenized texts
