...
class SAINT(BaseTabularModelWithAttention):
    ...
    Args:
        ...
        cat_embed_input (List, Optional, default = None): List of Tuples with the column name and number of unique values and
        ...
        attn_dropout (float, default = 0.2): Dropout that will be applied to the Multi-Head Attention column and
            row layers
    ...
    Attributes:
        ...
        saint_blks (nn.Sequential): Sequence of SAINT-Transformer blocks
        saint_mlp (nn.Module): MLP component in the model
